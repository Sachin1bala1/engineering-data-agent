...
export const ColumnInfoDialog: React.FC<ColumnInfoDialogProps> = ({ open, column, onOpenChange, onSave }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Column Info</DialogTitle>
          <DialogDescription>Metadata, units, format, description, and analytical role for the selected column.</DialogDescription>
        </DialogHeader>
        {column ? (
