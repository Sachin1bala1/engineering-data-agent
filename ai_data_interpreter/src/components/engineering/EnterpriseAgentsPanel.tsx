...
export function EnterpriseAgentsPanel() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Enterprise AI Agents</CardTitle>
        <CardDescription>
          Closed-loop Action Agent, Root-Cause Agent, and Autonomous DOE Orchestrator.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <Input placeholder="Objective (optional)" value={objective} onChange={(e) => setObjective(e.target.value)} />
