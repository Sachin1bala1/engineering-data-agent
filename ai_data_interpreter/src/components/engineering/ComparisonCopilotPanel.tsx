...
export function ComparisonCopilotPanel({ report }: ComparisonCopilotPanelProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Engineering Copilot (Baseline vs Experiment)</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="text-xs text-gray-500 flex flex-wrap items-center gap-2">
          ...
          <span>Signals: {report.signal_comparison.length}</span>
        ...
        {response && (
          <div className="space-y-3 text-sm text-gray-700">
            ...
            <div className="whitespace-pre-wrap break-words">{response.summary}</div>
